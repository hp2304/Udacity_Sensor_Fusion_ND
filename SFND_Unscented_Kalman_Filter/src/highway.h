...
public:
	...
	Highway(pcl::visualization::PCLVisualizer::Ptr& viewer, std::unordered_map<std::string, std::string> configs)
	{
		...
		trackCars[0] = configs["TRACK_CAR1_FLAG"] == "1";
		trackCars[1] = configs["TRACK_CAR2_FLAG"] == "1";
		trackCars[2] = configs["TRACK_CAR3_FLAG"] == "1";

		visualize_lidar = configs["VIS_LIDAR_FLAG"] == "1";
		visualize_radar = configs["VIS_RADAR_FLAG"] == "1";
		visualize_pcd = configs["VIS_PCD_FLAG"] == "1";
